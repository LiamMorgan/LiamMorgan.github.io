...
export default function Projects() {
	return (
		<div className="row no-gutters justify-content-around align-items-stretch d-flex mx-2 projects">
			...
			<ProjectItem
				image=""
				title="WIP Messenger Toolkit"
				description={
					<p>
						A WIP Chrome extension that adds more functionality to the standard{" "}
						<a href="https://messenger.com/">Messenger.com</a> site to improve
						user experience
					</p>
				}
			...
			<ProjectItem
				...
				description={
					<p>
						A <a href="https://momentumdash.com/">Momentum</a> extension clone
						in a web page, Intended to be set as the browsers new tab page for
						clock, todo list, tasks, quotes, etc.
					</p>
				}
